            ...
            <div className="flex min-h-screen flex-col">
              <header className="border-b border-slate-200 bg-white/80 backdrop-blur dark:border-slate-700 dark:bg-slate-900/80">
                <div className="mx-auto flex w-full max-w-4xl items-center justify-between px-4 py-4">
                  <Link href="/" className="text-xl font-semibold text-brand-600 dark:text-brand-300">
                    Babysteps
                  </Link>
                  <nav className="flex items-center gap-4 text-sm font-medium text-slate-600 dark:text-slate-300">
                    <Link href="/history" className="hover:text-brand-600 dark:hover:text-brand-200">
                      History
                    </Link>
                    <Link href="/stats" className="hover:text-brand-600 dark:hover:text-brand-200">
                      Stats
                    </Link>
                    <Link href="/settings" className="hover:text-brand-600 dark:hover:text-brand-200">
                      Settings
                    </Link>
                  </nav>
                </div>
